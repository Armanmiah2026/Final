package com.example.bongovpn.utils;
...
public class PayloadGeneratorDialog {
    ...
    public void setInitialPayload(String value) {
        this.initialPayload = value;
    }
    ...
    public void show() {
        ...
        dialog.setOnShowListener(x -> {
            if (dialog.getWindow() != null) {
                ...
                dialog.getWindow().setStatusBarColor(android.graphics.Color.rgb(2,15,24));
                dialog.getWindow().setNavigationBarColor(android.graphics.Color.rgb(2,15,24));
            }
            if (dialog.getButton(BUTTON_POSITIVE) != null) dialog.getButton(BUTTON_POSITIVE).setTextColor(android.graphics.Color.rgb(20,191,255));
            if (dialog.getButton(BUTTON_NEGATIVE) != null) dialog.getButton(BUTTON_NEGATIVE).setTextColor(android.graphics.Color.rgb(180,205,214));
        });
        dialog.show();
        if (dialog.getWindow() != null) dialog.getWindow().setLayout(-1, (int)(context.getResources().getDisplayMetrics().heightPixels * 0.90f));
    }
    ...
    private View generatorView(){
        ...
        load();
        if (initialPayload != null) payload.setText(initialPayload);
